  ...
  <div class="main-view">
    ...
    <header class="app-header">
      <div class="header-left">
        <div class="brand" @click="router.push('/')">GTM SIM LAB</div>
      </div>
...
const currentPhase = ref(-1) // -1: Upload, 0: Ontology Gen, 1: Build, 2: Complete
...
const handleNextStep = (params = {}) => {
  if (currentStep.value < 5) {
    ...
    // If entering Step 3 from Step 2, log simulation round count config
