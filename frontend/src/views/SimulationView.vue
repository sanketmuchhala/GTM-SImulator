...
const currentStatus = ref('processing') // processing | completed | error (in SimulationView)
...
const handleNextStep = (params = {}) => {
  ...
  // Log simulation round count config
  if (params.maxRounds) {
 ...
 * When user returns from Step 3 to Step 2, we assume they want to exit the simulation
 */
