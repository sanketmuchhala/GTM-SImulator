...
Manages dual-platform parallel simulation on Twitter and Reddit
    ...
    def prepare_simulation(
        ...
        try:
            ...
            profiles = generator.generate_profiles_from_entities(
                ...
                graph_id=state.graph_id,          # passed for Zep retrieval
            ...
            # Reddit profiles are already saved incrementally during generation — save again to ensure completeness
            if progress_callback:
                progress_callback(
            ...
            # Note: run scripts remain in backend/scripts/ and are not copied to the simulation directory.
            # When a simulation is launched, simulation_runner runs the scripts from the scripts/ directory.
