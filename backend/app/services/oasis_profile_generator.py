...
Convert entities from the Zep graph into Agent Profile format required by OASIS simulation platforms
...
class OasisAgentProfile:
    ...
    def to_reddit_format(self) -> Dict[str, Any]:
        ...
        profile = {
            ...
            "username": self.user_name,  # OASIS requires the field name username without underscore
            "name": self.name,
            "bio": self.bio,
...
class OasisProfileGenerator:
    ...
    2. Generate detailed personas including basics, career history, personality traits, and social media behavior
    3. Distinguish individual entities from abstract group entities
    """
    ...
    # Individual entity types requiring specific personas
    INDIVIDUAL_ENTITY_TYPES = [
        "student", "alumni", "professor", "person", "publicfigure", 
        "expert", "faculty", "official", "journalist", "activist"
    ]
    
    # Group/institution entity types requiring representative personas
    GROUP_ENTITY_TYPES = [
    ...
    def _build_entity_context(self, entity: EntityNode) -> str:
        """
        Build complete context for the entity
        
        Includes:
        1. the entity edge information (facts)
        ...
        # 3. Add details of related nodes
        ...
        if zep_results.get("facts"):
            # Deduplicate by excluding existing facts
    ...
    def _is_individual_entity(self, entity_type: str) -> bool:
        """Determine whether this is an individual entity"""
        return entity_type.lower() in self.INDIVIDUAL_ENTITY_TYPES
    
    def _is_group_entity(self, entity_type: str) -> bool:
        """Determine whether this is a group/institution entity"""
    ...
    def _generate_profile_with_llm(
        ...
        # Retry generation until success or max retries
        max_attempts = 3
        last_error = None
        ...
        for attempt in range(max_attempts):
            try:
                ...
                if finish_reason == 'length':
                    logger.warning(f"LLM output was truncated (attempt {attempt+1}), trying repair...")
    ...
    def _try_fix_json(self, content: str, entity_name: str, entity_type: str, entity_summary: str = "") -> Dict[str, Any]:
        ...
        # 1. First try repairing truncation
        content = self._fix_truncated_json(content)
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        ...
        base_prompt = "You are an expert social media persona generator. Create detailed, realistic personas for public-opinion simulation while reflecting known real-world context as faithfully as possible. You must return valid JSON, and string values must not contain unescaped newline characters."
    ...
    def _build_individual_persona_prompt(
        ...
        return f"""Generate a detailed social media user persona for this entity while reflecting known real-world context as faithfully as possible.
...
2. persona: detailed persona description, about 2000 words of plain text, including:
   - Basic information: age, profession, education background, location
   - Personal background: major experiences, connection to the event, social relationships
   ...
   - Stance and viewpoints: attitude toward the topic, content that may anger or move the person
   - Distinctive traits: catchphrases, special experiences, personal hobbies
   - Personal memory: an important part of the persona describing this individual's relationship to the event and their known actions and reactions in it
...
- {get_language_instruction()} (the gender field must use English values: male/female)
...
"""
    ...
    def _build_group_persona_prompt(
        ...
        return f"""Generate a detailed social media account profile for this institution or group entity while reflecting known real-world context as faithfully as possible.
...
2. persona: detailed account profile, about 2000 words of plain text, including:
   - Institutional basics: formal name, organization type, founding background, main responsibilities
   ...
   - Publishing patterns: content types, posting frequency, active time periods
   - Stance and attitude: official stance on core topics and handling of controversy
   - Special notes: represented group profile and operating habits
   - Institutional memory: an important part of the persona describing this institution's relationship to the event and its known actions and reactions
3. age: fixed value 30, the virtual age of the institutional account
4. gender: fixed value "other", used for non-individual accounts
5. mbti: MBTI type describing account style, such as ISTJ for rigorous and conservative
6. country: country, in English
...
- {get_language_instruction()} (the gender field must be exactly "other")
- age must be integer 30, and gender must be string "other"
- The institutional account's speech must match its identity and role"""
    ...
    def generate_profiles_from_entities(
        ...
        Args:
            ...
            realtime_output_path: realtime output path; if provided, write after each generated profile
        ...
        completed_count = [0]  # use list so it can be modified in closures
        lock = Lock()
        
        # helper for realtime file writing
        ...
        def generate_single_profile(idx: int, entity: EntityNode) -> tuple:
            """Worker function for generating one profile"""
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=parallel_count) as executor:
            ...
            for future in concurrent.futures.as_completed(future_to_entity):
                ...
                try:
                    ...
                    # Write to file in realtime (including fallback personas)
                    save_profiles_realtime()
    ...
    def _print_generated_profile(self, entity_name: str, entity_type: str, profile: OasisAgentProfile):
        """Output generated persona to console in realtime (full content, not truncated)"""
        separator = "-" * 70
        
        # Build complete output content without truncation
        ...
        # Only output to console to avoid duplicate full logger output
        print(output)
    ...
    def save_profiles(
        ...
        """
        Save profiles to file using the correct platform format
    ...
    def _save_twitter_csv(self, profiles: List[OasisAgentProfile], file_path: str):
        """
        Save Twitter profiles as CSV matching OASIS official requirements
        ...
        with open(file_path, 'w', newline='', encoding='utf-8') as f:
            ...
            for idx, profile in enumerate(profiles):
                ...
                # Handle newlines by replacing them with spaces in CSV
    ...
    def _save_reddit_json(self, profiles: List[OasisAgentProfile], file_path: str):
        ...
        Must include user_id; this is required for OASIS agent_graph.get_agent() matching.
    ...
    def save_profiles_to_json(
        ...
        logger.warning("save_profiles_to_jsonDeprecated，please usesave_profilesmethod")
